...
d=$("<div></div>");d.attr("id","videocontrols");c.append(d);DOMUtil.isIPhone()||(d=$('<div class="spinnerwrap" id="spinner-control"> <div class="spinner spinner--indeterminate spinner--overBackground"><div class="spinner-track"></div><div class="spinner-fills"><div class="spinner-fillMask1"><div class="spinner-fillSubMask1"><div class="spinner-fill"></div></div></div><div class="spinner-fillMask2"><div class="spinner-fillSubMask2"><div class="spinner-fill"></div></div></div></div></div></div>'),a.append(d));
a=$("<div></div>");a.addClass("startcover");a.attr("id","startcover");c.append(a);a=$("<div></div>");a.attr("id","html5-video-poster");c.append(a);a=$("<div></div>");a.attr("id","messages");a.addClass("message-container");c.append(a);b.append(c);return b};d.prototype.attachToVideoElement=function(a){var b=$(a);a=b.parent();b=this.createWrapper(b);a.append(b);return this.loadPlayer(b)};d.prototype.updateSource=function(b){if(DOMUtil.isSafari()||DOMUtil.isIOS()||DOMUtil.isFireFoxAndroid()){var c=b.find("video").first();
if(c&&(c=c.find("source[type='application/x-mpegURL']"))&&0<c.length){var d=c[0].src,e=d.indexOf("?"),f={};f[a.WWW_PROXY_PLAYBACK_QUERY]=d.substring(0,e);f[a.WWW_PROXY_TOKEN_QUERY]=d.substr(e+1);d=this.getWWWHost(b);b=document.createElement("a");b.setAttribute("href",d);(d=this.getGatewayApiKeyFromUrlQueryParams(b.search))&&(f[a.WWW_GATEWAY_API_KEY_QUERY]=d);f=jQuery.param(f);c[0].src=b.protocol+"//"+b.hostname+(b.port?":"+b.port:"")+a.WWW_API_MANIFEST_ENDPOINT+"?"+f}}};d.prototype.loadPlayer=function(a){this.createConfiguration(a);
this.updateSource(a);var c=this.config.isConfigOptionEnabled("lazyLoading"),d=a.find("video");d.attr("display","none");if(c){var e=this,c=$(".html5-video-wrapper");d.attr("preload","none");var g=$.Deferred(),d=this.config.getConfigValue("poster");$("#html5-video-poster").css("background-image","url("+d+")");$("#html5-video-holder").addClass("idle");0==e.config.getConfigValue("clientappname").length||e._loadEventSent||(e._loadEventSent=!0,VideoProperties.setProperties(a,e.config),e.dunamisEventSender=
f.getInstance(e.config),e.dunamisEventSender.sendEvent(DunamisEventFactory.getEvent(b.RENDER)));c.on("click",function(b){b.preventDefault();e.attachTo(a).done(function(a){g.resolve(a)}).fail(function(){g.reject()})});return g.promise()}d.attr("preload","auto");return this.attachTo(a)};d.prototype.attachTo=function(a){var c=$.Deferred(),e=this;this._attached||!a.length?c.reject():(e._attached=!0,LOGGING&&com$adobe$ccv$logging.ConsoleLogger.isAvailable()&&Log.addLogger(new ConsoleLogger(d._LOGTAG)),
